      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <ul class="list-unstyled">
            ...
            <li> <strong> <?php echo $_SESSION ['s_name'];?> </strong> </li>
  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">น้ำพริกนายแปด</h1>
        <p class="lead text-body-secondary">อิรัชชัยมาเสะ.</p>
        <p>
          <a href="#" class="btn btn-primary my-2">สวัสดี</a>
          <a href="#" class="btn btn-secondary my-2">hello</a>
        </p>
      </div>
    </div>
  </section>
